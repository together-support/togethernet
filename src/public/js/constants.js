...
export const systemConfirmMsg_archivalRoom = {
...
export const systemConfirmMsg_disconnect = {
...
export const systemConfirmMsg_confirmConsentToArchive = {
  msgHeader: 'Consent to Archive',
  msgBody: 'Consent to archive is a feature that publishes a single message or a thread to the database connected to this instance. When the consent to archive process is initiated, all activities are paused and participants are asked to give their consent for the selected message to be archived. The message will not be archived if one or more participant decides to stop the process.',
...
export const systemConfirmMsg_initiateConsentToArchiveProcess = {
...
export const systemConfirmMsg_consentToArchive = {
...
export const systemNotifyMsg_consentToArchiveBlocked = {
  msgHeader: 'Consent to Archive Stopped',
