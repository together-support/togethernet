...
import { systemNotifyMsgConsentToArchiveBlocked } from "@js/constants.js";
...
export const handleData = ({ event, peerId }) => {
  ...
  if (data.type === "text") {
    ...
    addSystemNotifyMessage({
      msgHeader: systemNotifyMsgConsentToArchiveBlocked.msgHeader,
      msgBody: `${name} ${systemNotifyMsgConsentToArchiveBlocked.msgBody}`,
      confirmText: systemNotifyMsgConsentToArchiveBlocked.confirmText,
      confirmBtn: systemNotifyMsgConsentToArchiveBlocked.confirmBtn,
      confirmBtnTitle: systemNotifyMsgConsentToArchiveBlocked.confirmBtnTitle,
    });
