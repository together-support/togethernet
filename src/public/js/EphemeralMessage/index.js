...
export default class EphemeralMessage {
	...
	consentToArchiveButtonClicked = () => {
		// addSystemMessage(
		// 	"You have just asked for everyone's consent to archive the message."
		// );
		if (confirm('are you sure?')) {
			this.initiateConsentToArchiveProcess();
		}
	};
