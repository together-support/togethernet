...
export default class SignalingServer {
  ...
  initConnections = (initiator) => {
    const peerIds = Object.keys(this.io.sockets.connected).filter(
      (socketId) => socketId !== initiator.id
    );
    peerIds.forEach((peerId) => {
      this.sendConnection(initiator, {
        type: 'initConnections',
